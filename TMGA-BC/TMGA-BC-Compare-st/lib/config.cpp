...
void ConfigParameter_TMGA() {// -xy
    ...
    Parameter_TMGA.NumOfSubPop = 5;                                                     //set the number of subpopulations
    Parameter_TMGA.interval = 6;                                                       // set the exchange interval/0.8
    Parameter_TMGA.NumOfEliteOfPop = ceil(Parameter_TMGA.NumOfChrInSubPop * 0.3);   //set the number of elitist for exchange -xy
    Parameter_TMGA.MutationRate_TMGA = 0.1;                                            //set the mutation rate
