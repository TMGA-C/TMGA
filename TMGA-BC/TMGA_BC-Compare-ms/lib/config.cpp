...
void ReadFile(string XmlFile, string RscAlcFile) {
    ...
    Resource Rsc_0 = Resource(0, 1, 20);
...
void ConfigParameter_TMGA() {
    Parameter_TMGA.NumOfChrInSubPop = Tasks.size()*1;                                   //set the subpopulation size
    ...
    Parameter_TMGA.interval = 10;                                                       // set the exchange interval/0.8
    Parameter_TMGA.NumOfEliteOfPop = ceil(Parameter_TMGA.NumOfChrInSubPop * 0.7);   //set the number of elitist for exchange
    Parameter_TMGA.MutationRate_TMGA = 0.15;                                            //set the mutation rate
    Parameter_TMGA.TrmThresholdOfStg1 = ceil(6 * ModelScale / Parameter_TMGA.NumOfChrInSubPop / Parameter_TMGA.NumOfSubPop);  //set the termination condition of stage 1
}
